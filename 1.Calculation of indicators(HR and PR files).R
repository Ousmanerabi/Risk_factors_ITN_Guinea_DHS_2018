...
##
## Number of ITN in household, (If only ITN take account, otherwise take hml1 only)
...
## Recode the variables to be included in the analysis of risk factors for ITN ownership
...
## Proportion of HH with at least one ITN
...
### Calculate the different indicators in the individual file
...
## proportion in hh with access
#dplyr::mutate(access2=ifelse(potuse_ajusted/defacto_pop == 1, 1, 0)) #%>%
